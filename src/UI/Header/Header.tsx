   ...
   const accountsLink = [
    ...
    return (
      ...
      <div className="all-container sticky top-0 z-50">
         <div className="main bg-[#131921] md:flex justify-between  ">
            <div className="all-content flex justify-between    items-center mx-4 py-2 cursor-pointer">
                  ...
                  <div className="logo-area flex ">
                     ...
                     {/* location area start */}
                      <div className="hidden md:block">
                        <div className="location   w-[200px] flex gap-1  items-center  duration-300  hover:border-[white] p-1 border  border-transparent">
               ...
               {/*==================== header search area start================== */}
                      <div  className="search-area w-[650px] hidden md:block   overflow-hidden focus-within:border-[#FF9900] border-[3px] border-transparent    rounded-md">
               ...
               {/*======================== countery are start===================== */}
                  <div className="menu-area  flex gap-4  items-center text-white justify-between">
                     <div className="countery-area  md:block hidden">
                           <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className="flag-area p-4 ">
                              ...
                              {
                              closeMenu && (
                                 <div onMouseEnter={handleMouseEnter} className="incuked hidden bg-[white] z-50 top-14 absolute text-black">
                     ...
                     { 
                        ...
                        session?.user ?    (
                              ...
                              <div className="all-profile relative ">
                     ...
                     <Link href="/cart" className="card">
                        <div className="profile hoverBorder flex items-center gap-4">
                     ...
                     <div className="main md:hidden">
                        <HiBars3BottomRight className="text-3xl mt-2" />
                     </div>
                  </div>
               {/*======================== countery are end===================*/}
            </div>
